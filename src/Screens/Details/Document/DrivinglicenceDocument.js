...
export default function DrivingLicenceDocument({navigation, route}) {
  ...
  const getDl = () => {
    setDrivingLicense(
      route.params.data.drivingLicense == null
        ? ''
        : route.params.data.drivingLicense,
    );
    setUploadImageuri(
      route.params.data.drivingLicenseimage == null
        ? ''
        : Constant.ShowImage + route.params.data.drivingLicenseimage,
    );
  };
  ...
  const onResubmit = async DrivingImage => {
    if (netInfo == 'online') {
      const data = {
        id: route.params.id,
        // applicationStatus: 6,
  ...
  const onSubmitData = async DrivingImage => {
    if (netInfo == 'online') {
      const data = {
        id: route.params.id,
        //  applicationStatus: 6,
            ...
            <TextInput
              ...
              onChangeText={value => {
                if (value.includes(' ')) {
                  ...
                  setDrivingLicense(
                    value.toUpperCase().replace(/[^\w\s]/gi, ''),
                  );
                }
              }}
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                ...
                <View style={{flex: 1}}>
                  <CustomButton
                    text="Edit"
                    onPress={() => {
                      navigation.push('DrivingLicenceDocument', {
                        isEdit: true,
                        AgainEdit: true,
                        id: route.params.id,
